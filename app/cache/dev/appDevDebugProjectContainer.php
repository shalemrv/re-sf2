...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'model.advert' => 'getModel_AdvertService',
            'model.client' => 'getModel_ClientService',
            'model.mail' => 'getModel_MailService',
            'model.profile' => 'getModel_ProfileService',
            'model.security' => 'getModel_SecurityService',
            'model.user' => 'getModel_UserService',
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => 3306, 'dbname' => 'real-estate', 'user' => 'shalemv', 'password' => 'Raj@1995', 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'\\src\\Mrsuh\\RealEstateBundle\\Entity'))), 'Mrsuh\\RealEstateBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('MrsuhRealEstateBundle' => 'Mrsuh\\RealEstateBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_fe6aa2ebb8c5ff89d8d4f83714d9581aa95682fcf1451d9394c81818ea45715b');
    ...
    /**
     * Gets the 'model.advert' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Mrsuh\RealEstateBundle\Model\AdvertModel A Mrsuh\RealEstateBundle\Model\AdvertModel instance.
     */
    protected function getModel_AdvertService()
    {
        return $this->services['model.advert'] = new \Mrsuh\RealEstateBundle\Model\AdvertModel($this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the 'model.client' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Mrsuh\RealEstateBundle\Model\ClientModel A Mrsuh\RealEstateBundle\Model\ClientModel instance.
     */
    protected function getModel_ClientService()
    {
        return $this->services['model.client'] = new \Mrsuh\RealEstateBundle\Model\ClientModel($this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the 'model.mail' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Mrsuh\RealEstateBundle\Model\MailModel A Mrsuh\RealEstateBundle\Model\MailModel instance.
     */
    protected function getModel_MailService()
    {
        return $this->services['model.mail'] = new \Mrsuh\RealEstateBundle\Model\MailModel($this->get('swiftmailer.mailer.default'), NULL);
    }

    /**
     * Gets the 'model.profile' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Mrsuh\RealEstateBundle\Model\ProfileModel A Mrsuh\RealEstateBundle\Model\ProfileModel instance.
     */
    protected function getModel_ProfileService()
    {
        return $this->services['model.profile'] = new \Mrsuh\RealEstateBundle\Model\ProfileModel($this->get('doctrine.orm.default_entity_manager'));
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \Mrsuh\RealEstateBundle\Model\SecurityModel A Mrsuh\RealEstateBundle\Model\SecurityModel instance.
     */
    protected function getModel_SecurityService()
    {
        return $this->services['model.security'] = new \Mrsuh\RealEstateBundle\Model\SecurityModel($this->get('model.user'), $this->get('model.mail'), 'real-estate', $this->targetDirs[2]);
    }

    /**
     * Gets the 'model.user' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Mrsuh\RealEstateBundle\Model\UserModel A Mrsuh\RealEstateBundle\Model\UserModel instance.
     */
    protected function getModel_UserService()
    {
        return $this->services['model.user'] = new \Mrsuh\RealEstateBundle\Model\UserModel($this->get('doctrine.orm.default_entity_manager'), $this->get('model.mail'));
    }
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('Mrsuh\\RealEstateBundle\\Entity\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\MessageDigestPasswordEncoder', 'arguments' => array(0 => 'sha512', 1 => true, 2 => 10))));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_SecuredAreaService()
    {
        ...
        $g->setOptions(array('login_path' => 'login', 'always_use_default_target_path' => true, 'default_target_path' => 'find_advert', 'target_path_parameter' => '_target_path', 'use_referer' => false));
        ...
        return $this->services['security.firewall.map.context.secured_area'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('security.user.provider.concrete.main')), 'secured_area', $b, $c), 2 => $f, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($a, $this->get('security.authentication.manager'), new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate'), $d, 'secured_area', $g, $h, array('check_path' => 'login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $b, $c, NULL), 4 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $d, 'secured_area', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $d, 'login', false), NULL, NULL, $b));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\Mrsuh\\RealEstateBundle/Resources/views'), 'MrsuhRealEstate');
    ...
    protected function getSecurity_AccessMapService()
    {
        ...
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/profile$'), array(0 => 'ROLE_USER', 1 => 'ROLE_ADMIN'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/find-advert$'), array(0 => 'ROLE_USER', 1 => 'ROLE_ADMIN'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/create-advert$'), array(0 => 'ROLE_USER', 1 => 'ROLE_ADMIN'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/advert'), array(0 => 'ROLE_USER', 1 => 'ROLE_ADMIN'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/find-advert-by-client$'), array(0 => 'ROLE_USER', 1 => 'ROLE_ADMIN'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/find-client$'), array(0 => 'ROLE_USER', 1 => 'ROLE_ADMIN'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/create-client$'), array(0 => 'ROLE_USER', 1 => 'ROLE_ADMIN'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/client$'), array(0 => 'ROLE_USER', 1 => 'ROLE_ADMIN'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/users$'), array(0 => 'ROLE_ADMIN'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/create-user$'), array(0 => 'ROLE_ADMIN'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/change-user-advert-list$'), array(0 => 'ROLE_ADMIN'), NULL);
    ...
    {
        return $this->services['security.user.provider.concrete.main'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider($this->get('doctrine'), 'Mrsuh\\RealEstateBundle\\Entity\\User', 'username', NULL);
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'MrsuhRealEstateBundle' => 'Mrsuh\\RealEstateBundle\\MrsuhRealEstateBundle',
            ...
            'database_user' => 'shalemv',
            'database_password' => 'Raj@1995',
            'mailer_transport' => 'mail',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'secret' => 'ThisTokenIsNotSoSecretChangeIt',
            'fixtures_object_balcony' => ($this->targetDirs[2].'/config/fixtures/object/balcony.yml'),
            'fixtures_object_heating' => ($this->targetDirs[2].'/config/fixtures/object/heating.yml'),
            'fixtures_object_state' => ($this->targetDirs[2].'/config/fixtures/object/state.yml'),
            'fixtures_object_type' => ($this->targetDirs[2].'/config/fixtures/object/type.yml'),
            'fixtures_object_wall' => ($this->targetDirs[2].'/config/fixtures/object/wall.yml'),
            'fixtures_object_water_supply' => ($this->targetDirs[2].'/config/fixtures/object/water_supply.yml'),
            'fixtures_object_wc' => ($this->targetDirs[2].'/config/fixtures/object/wc.yml'),
            'fixtures_address_city' => ($this->targetDirs[2].'/config/fixtures/address/city.yml'),
            'fixtures_advert_type' => ($this->targetDirs[2].'/config/fixtures/advert/type.yml'),
            'fixtures_advert_category' => ($this->targetDirs[2].'/config/fixtures/advert/category.yml'),
            'locale' => 'en',
            ...
            'assetic.java.bin' => 'C:\\Program Files\\Eclipse Adoptium\\jdk-19.0.2.7-hotspot\\bin\\java.EXE',
